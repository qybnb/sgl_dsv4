...
# path
export PYTHONPATH=/xxxxx/sglang/python:$PYTHONPATH
MODEL_PATH=/xxxx/DeepSeek-V4-Flash-w8a8-mtp-ms
...
PORT=30000
SERVER_LOG=/xxxx/sglang_server.log
...
BENCH_LOG=/xxxxx/bench_serving.log
echo "Running benchmark, results -> ${BENCH_LOG}"
python3 -m sglang.bench_serving \
    --dataset-path /xxxx/ShareGPT_V3_unfiltered_cleaned_split.json \
    --dataset-name random \
    --backend sglang \
    --host ${CLIENT_HOST} \
    --port ${PORT} \
